...
public class VehicleExceptionTest {
    ...
    private static Class<VehicleException> testClass;
    private static Constructor<VehicleException>[] testConstructors;
    private static Field[] testFields;
    private static Method[] testMethods;

    private static VehicleException testInstance;

    private static String parameter = "licencePlate";
    ...
    public static void setUpBeforeClass() throws Exception {
        testClass = VehicleException.class;
        testConstructors = (Constructor<VehicleException>[]) testClass.getDeclaredConstructors();
        ...
        if (checkConstructor()) {
            ...
            testInstance =
                    (VehicleException) testConstructors[0].newInstance(parameter);
        }
    }
...
*/
    ...
    public void testClass() {
        ...
        assertEquals(Exception.class, ancestor);
    ...
    public void testParameter() throws IllegalAccessException {
        ...
        Field testField = assertField(
                "parameter", String.class, Modifier.PRIVATE);
